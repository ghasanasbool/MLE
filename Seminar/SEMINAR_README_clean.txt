...
Edit 03 note
------------
The HTML page now includes "Run this step" buttons in the R coding walkthrough. These buttons simulate the expected R outputs using the embedded S&P 500 data; they do not execute R inside the browser.
